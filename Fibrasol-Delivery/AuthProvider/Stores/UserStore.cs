...
namespace Fibrasol_Delivery.AuthProvider.Stores
{
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        /// </summary>
        private IList<TUserClaim> UserClaims { get; set; } = default!;
        /// <summary>
        /// Internally keeps the roles of a user.
        /// </summary>
        private IList<TUserRole> UserRoles { get; set; } = default!;
        /// <summary>
        /// Internally keeps the logins of a user.
        /// </summary>
        private IList<TUserLogin> UserLogins { get; set; } = default!;
        /// <summary>
        /// Internally keeps the tokens of a user.
        /// </summary>
        private IList<TUserToken> UserTokens { get; set; } = default!;
        /// <summary>
        /// Abstraction for interacting with AspNetUsers table.
        /// </summary>
        public IUsersTable<TUser, TKey, TUserClaim, TUserRole, TUserLogin, TUserToken> UsersTable { get; } = default!;
        /// <summary>
        /// Abstraction for interacting with AspNetUserClaims table.
        /// </summary>
        public IUserClaimsTable<TKey, TUserClaim> UserClaimsTable { get; } = default!;
        /// <summary>
        /// Abstraction for interacting with AspNetUserRoles table.
        /// </summary>
        public IUserRolesTable<TRole, TKey, TUserRole> UserRolesTable { get; } = default!;
        /// <summary>
        /// Abstraction for interacting with AspNetUserLogins table.
        /// </summary>
        public IUserLoginsTable<TUser, TKey, TUserLogin> UserLoginsTable { get; } = default!;
        /// <summary>
        /// Abstraction for interacting with AspNetUserTokens table.
        /// </summary>
        public IUserTokensTable<TKey, TUserToken> UserTokensTable { get; } = default!;
        /// <summary>
        /// Abstraction for interacting with AspNetRoles table.
        /// </summary>
        public IRolesTable<TRole, TKey, TRoleClaim> RolesTable { get; } = default!;
